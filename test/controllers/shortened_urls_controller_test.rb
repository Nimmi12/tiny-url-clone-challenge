...
class ShortenedUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shortened_url" do
    assert_difference('ShortenedUrl.count') do
      post shortened_urls_url, params: { shortened_url: { slug: @shortened_url.slug, url: @shortened_url.url } }
    end
  ...
  test "should update shortened_url" do
    patch shortened_url_url(@shortened_url), params: { shortened_url: { slug: @shortened_url.slug, url: @shortened_url.url } }
